...
class ObjOuterArea
{
	...
	public static function echo_top($active_tab)
	{
		...
		<!-- leading space between banner and menu -->
					  ...
					  <td><a class="' . (($active_tab == self::$TAB_SALES_ORDERS) ? 'active_menu' : 'menu') . '" href="page_sales_menu.php">Sales Orders</a></td></tr><tr>
					  <td><a class="' . (($active_tab == self::$TAB_PURCHASES) ? 'active_menu' : 'menu') . '" href="page_purchases_menu.php">Purchases</a></td></tr><tr>
					  <td><a class="' . (($active_tab == self::$TAB_CUSTOMERS) ? 'active_menu' : 'menu') . '" href="page_customers_menu.php">Customers</a></td></tr><tr>
					  <td><a class="' . (($active_tab == self::$TAB_PRODUCTS) ? 'active_menu' : 'menu') . '" href="page_products_menu.php">Products</a></td></tr><tr>					  
					  <td><a class="' . (($active_tab == self::$TAB_SUPPLIERS) ? 'active_menu' : 'menu') . '" href="page_suppliers_menu.php">Suppliers</a></td></tr><tr>
					  <td><a class="' . (($active_tab == self::$TAB_SHIPPERS) ? 'active_menu' : 'menu') . '" href="page_shippers_menu.php">Shippers</a></td></tr><tr>					  
					  <td><a class="' . (($active_tab == self::$TAB_REPORTS) ? 'active_menu' : 'menu') . '" href="page_reports_menu.php">Reports</a></td></tr><tr>
					</tr>
