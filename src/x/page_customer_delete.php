...
For example, if
	page_customer_delete?f_id=5
is accessed, customer with id 5 will have its trash flag set to 1
*/
class PageCustomerDelete
{
	//*** CONSTANTS ***
	private static $THIS_PAGE = 'page_customer_delete.php';
	...
	private function show_output($err_msg = '')
	{
		...
		else
		{
			echo ('
				<tr>
					<td align="center"> Customer has been deleted.</td>
				</tr>
			');
		}
...
$page_customer_delete = new PageCustomerDelete();
$page_customer_delete->run();
