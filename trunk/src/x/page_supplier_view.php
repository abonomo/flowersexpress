...
class PageSupplierView
{
	...
	{
			//Query for supplier info and created employee info from database
			...
			$this->f_created_employee_id	= $suppl_info['created_employee_id'];
			$this->f_updated_employee_id	= $suppl_info['updated_employee_id'];
