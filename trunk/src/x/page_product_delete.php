...
For example, if
	page_product_delete?f_id=5
is accessed, product with id 5 will have its trash flag set to 1
*/
class PageProductDelete
{
	//*** CONSTANTS ***
	private static $THIS_PAGE = 'page_product_delete.php';
	...
	private function show_output($err_msg = '')
	{
		...
		else
		{
			echo ('
				<tr>
					<td align="center"> Product has been deleted.</td>
				</tr>
			');
		}
...
$page_product_delete = new PageProductDelete();
$page_product_delete->run();
