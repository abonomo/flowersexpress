...
/*
Undeletes a shipper with given id
For example, if
	page_shipper_undelete?f_id=5
is accessed, shipper with id 5 will have its trash flag set to 1
*/
class PageShipperUndelete
{
	//*** CONSTANTS ***
	private static $THIS_PAGE = 'page_shipper_undelete.php';
...
$page_shipper_undelete = new PageShipperUndelete();
$page_shipper_undelete->run();
