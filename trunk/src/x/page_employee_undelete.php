...
class PageEmployeeUndelete
{
	//*** CONSTANTS ***
	private static $THIS_PAGE = 'page_employee_undelete.php';
	...
	{
		//get id of employee to undelete
	...
	private function show_output($err_msg = '')
	{
		...
		else
		{
			echo ('
				<tr>
					<td align="center"> Employee has been undeleted.</td>
				</tr>
			');
		}
...
$page_employee_undelete = new PageEmployeeUndelete();
$page_employee_undelete->run();
